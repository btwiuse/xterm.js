...
import type { CursorTrailAddon } from 'xterm-addon-cursor-trail';

export type AddonType = 'attach' | 'clipboard' | 'fit' | 'image' | 'ligatures' | 'progress' | 'search' | 'serialize' | 'unicode11' | 'unicodeGraphemes' | 'webFonts' | 'webLinks' | 'webgl' | 'cursorTrail';
                        ...
                        T extends 'unicode11' ? typeof Unicode11Addon :
                          T extends 'unicodeGraphemes' ? typeof UnicodeGraphemesAddon :
                            T extends 'webgl' ? typeof WebglAddon :
                              T extends 'cursorTrail' ? typeof CursorTrailAddon :
                                never
  );
  instance?: (
                        ...
                        T extends 'unicode11' ? Unicode11Addon :
                          T extends 'unicodeGraphemes' ? UnicodeGraphemesAddon :
                            T extends 'webgl' ? WebglAddon :
                              T extends 'cursorTrail' ? CursorTrailAddon :
                                never
  );
}
